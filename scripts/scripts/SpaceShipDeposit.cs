...
public class SpaceShipDeposit : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(onGetKo)
        {
            Objective.text = "return Jellyium to SpaceShip";
            onGetKo = false;
        }
    }
    ...
    {
        if (PlayerPrefs.GetInt("BlackCrystal3", 0) == 1 && PlayerPrefs.GetInt("BlackCrystal2", 0) == 1 && PlayerPrefs.GetInt("BlackCrystal1", 0) == 1)
        {
